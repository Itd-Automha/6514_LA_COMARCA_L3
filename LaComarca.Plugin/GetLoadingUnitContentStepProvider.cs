...
namespace LaComarca.Plugin
{
    public class GetLoadingUnitContentStepProvider : IStepProvider
    {
        ...
        public ILoadingUnitStep CreateStep(ILoadingUnitMission mission, int stepId, IPosition source = null, IPosition destination = null, StepStatus status = StepStatus.New, string descr = null, ILink link = null, ICompoundLink compoundLink = null, StepWeight stepWeight = default)
